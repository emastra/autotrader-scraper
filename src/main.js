    ...
    const crawler = new Apify.PuppeteerCrawler({
        ...
        handlePageFunction: async ({ page, request, session }) => {
            ...
            if (label === 'FILTER') {
                ...
                const totalResults = await page.evaluate(() => Number(
            ...
            || title.includes('Access Denied')
              ...
              && document.querySelector("[aria-label='DRIVE TYPE']").parentElement
                  .nextSibling
                    ...
                    const engine = document.querySelector("[aria-label='ENGINE_DESCRIPTION']")
              ...
              && document.querySelector("[aria-label='ENGINE_DESCRIPTION']")
                  .parentElement.nextSibling
                    ...
                    const transmission = document.querySelector("[aria-label='TRANSMISSION']")
              ...
              && document.querySelector("[aria-label='TRANSMISSION']").parentElement
                  .nextSibling
                    ...
                    const mpg = document.querySelector("[aria-label='MPG']")
